...
GO
-----------------------------------------------------------------------------------------
-- Creación de las tablas que forman parte de la base de datos y su relación
-----------------------------------------------------------------------------------------
CREATE TABLE Perfil_jugador(
    ...
    FOREIGN KEY (id_pers) REFERENCES Personaje (id_pers),
    FOREIGN KEY (id_XP) REFERENCES Nivel_XP (id_XP),
    FOREIGN KEY (id_scene) REFERENCES escenario (id_scene),
    FOREIGN KEY (id_pt) REFERENCES ptAvance (id_pt)
)
GO
...
CREATE TABLE XPHABIL(
    ...
    id_habil INT,
    FOREIGN KEY (id_XP) REFERENCES Nivel_XP (id_XP),
    FOREIGN KEY (id_habil) REFERENCES Habilidad (id_habil)
)
GO
...
DROP TABLE Perfil_jugador

SELECT * FROM Perfil_jugador