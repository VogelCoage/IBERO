...
namespace ProyectoBarco
{
    ...
    */
    public class Lancha : Barco, INavegacion
    {
        ...
        /*Sobrecarga del constructor con 2 argumentos
        *que invoca al constructor de la clase padre con 2 argumentos
        **/
        public Lancha(string nombre, int noVelas) : base(nombre, noVelas)
        {
            motor = "Fuera de borda";
        }

        /*Sobrecarga del constructor con 3 argument que invoca al constructor de
        * la clase padre con 2 argumentos + el propio de la clase
        **/
